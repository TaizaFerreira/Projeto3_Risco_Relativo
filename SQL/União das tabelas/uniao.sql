## unindo as tabelas e excluindo com o INNER JOIN os 425 listados sem user_id##

CREATE OR REPLACE TABLE `riscorelativo2025.risco_relativo_projeto3.risco_relativo_unificada` AS
...
-- Etapa 2: Unificando com as outras tabelas — apenas usuários COM empréstimos
SELECT 
  ui.user_id,
  ui.age,
  ui.sex,
...
INNER JOIN emprestimos_agrupados AS ea
